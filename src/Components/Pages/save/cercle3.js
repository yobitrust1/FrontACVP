...
const Cercle3 = (props) => {
    ...
    var handleSubmit = (e) => {
        ...
        console.log(values)
        e.preventDefault();
        props.cercle3Patient(props.patientList["cin"], values)
        props.navigation.navigate("Cercle4")
    }
  ...
  <MDBContainer   >
        <MDBRow>
          <MDBCol >
            ...
            <Text style={tailwind('text-gray-700 font-bold text-xl text-center')}>{t("Epaissement absolu")}</Text>
            ...
            <NumericInput mobile className="form-control" min={0} max={100} onChange={handle16Change} />
                ...
                <View style={styles.row}>
                    <FormButton title={t("Précédent")} onPress={() => { props.navigation.navigate("Cercle2") }} />
                    <FormButton title={t("Enregistre")} onPress={handleSubmit} />
                </View>
                <FormButton title={t("Suivant")} onPress={() => { props.navigation.navigate("Cercle4") }} />
            </View>
           </MDBCard>
        </MDBCol>
      </MDBRow>
...
const mapActionToProps = {
    cercle3Patient: actions.cercle3Patient

};

export default connect(mapStateToProps, mapActionToProps)(Cercle3);
