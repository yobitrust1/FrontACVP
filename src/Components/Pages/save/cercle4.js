...
const Cercle4 = (props) => {
    ...
    var handleSubmit = (e) => {
        ...
        console.log(values)
        e.preventDefault();
        props.cercle4Patient(props.patientList["cin"], values)
        props.navigation.navigate("Dash31")
    }
          ...
          <MDBCol >
            ...
            <FormInput4  className="form-control" min={0} max={100} onChange={handle16Change} />
                ...
                <View style={styles.row}>
                    <FormButton title={t("Précédent")} onPress={() => { props.navigation.navigate("Cercle3") }} />
                    <FormButton title={t("Enregistre")} onPress={handleSubmit} />
                </View>
                <FormButton title={t("Suivant")} onPress={() => { props.navigation.navigate("Dash31") }} />
            </View>
           </MDBCard>
        </MDBCol>
      </MDBRow>
...
const mapActionToProps = {
    cercle4Patient: actions.cercle4Patient

};

export default connect(mapStateToProps, mapActionToProps)(Cercle4);
